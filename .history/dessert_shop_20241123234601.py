...
class DessertShop():
    def user_prompt_candy(self):
        print("Type in the type of candy(str), the weight in pounds(float), and the price per pound(float).")
        while True:
            candy_type = input("Candy type: ")
            if isinstance(candy_type, str):
                break
            else:
    ...
    def user_prompt_cookie(self):
        print("Type in the type of (str), the weight in pounds(float), and the price per pound(float).")
        while True:
            candy_type = input("Candy type: ")
            if isinstance(candy_type, str):
                break
